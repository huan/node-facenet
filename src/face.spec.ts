...
test('constructor()', async t => {
  ...
  t.test('via filename', async t => {
    ...
    t.deepEqual(face.imageData && face.imageData.data, EXPECTED_IMAGE_RGB_BWT_ARRAY, 'should load imageData with deasync')
  })
